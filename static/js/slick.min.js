...
(function(f) {
      ...
      c = function() {
         ...
         return function(b, e) {
            ...
            this.defaults = {
               ...
               arrows: !0,
               asNavFor: null,
               prevArrow: '\x3cbutton class\x3d"slick-prev" aria-label\x3d"Previous" type\x3d"button"\x3e' + (e.btnText ? "Previous" : "") + "\x3c/button\x3e",
               nextArrow: '\x3cbutton class\x3d"slick-next" aria-label\x3d"Next" type\x3d"button"\x3e' + (e.btnText ? "Next" : "") + "\x3c/button\x3e",
               autoplay: !1,
               autoplaySpeed: 3E3,
               centerMode: !1,
               centerPadding: "50px",
               ...
               customPaging: function(a, b) {
                  return f('\x3cbutton type\x3d"button" /\x3e')
                     .text(b + 1)
               },
               dots: !1,
            ...
            this.init(!0);
            if (this.$prevArrow && this.$nextArrow && this.$slider.offset()
               .top > document.documentElement.clientHeight) {
               d = this.$nextArrow.offset()
                  .left + this.$nextArrow.width();
               d = screen.width - d;
   ...
   c.prototype.addSlide = c.prototype.slickAdd = function(a, b, e) {
      ...
      this.unload();
      "number" === typeof b ? 0 === b && 0 === this.$slides.length ? f(a)
         .appendTo(this.$slideTrack) : e ? f(a)
         .insertBefore(this.$slides.eq(b)) : f(a)
         .insertAfter(this.$slides.eq(b)) : !0 === e ? f(a)
         .prependTo(this.$slideTrack) : f(a)
         .appendTo(this.$slideTrack);
      this.$slides = this.$slideTrack.children(this.options.slide);
      this.$slideTrack.children(this.options.slide)
         .detach();
   ...
   c.prototype.animateSlide = function(a, b) {
      ...
      !1 === d.transformsEnabled ? !1 === d.options.vertical ? d.$slideTrack.animate({
         ...
         top: a
      }, d.options.speed, d.options.easing, b) : !1 === d.cssTransitions ? (!0 === d.options.rtl && (d.currentLeft = -d.currentLeft), f({
         ...
         .animate({
            ...
            step: function(a) {
               a = Math.ceil(a);
               e[d.animType] = !1 === d.options.vertical ? "translate(" + a + "px, 0px)" : "translate(0px," + a + "px)";
               d.$slideTrack.css(e)
            },
            complete: function() {
               b && b.call()
            }
         })) : (d.applyTransition(), a = Math.ceil(a), e[d.animType] = !1 === d.options.vertical ? "translate3d(" + a + "px, 0px, 0px)" : "translate3d(0px," + a + "px, 0px)", d.$slideTrack.css(e), b && setTimeout(function() {
         d.disableTransition();
         b.call()
      }, d.options.speed))
   };
   ...
   c.prototype.applyTransition = function(a) {
      ...
      !1 === this.options.fade ? this.$slideTrack.css(b) : this.$slides.eq(a)
         .css(b)
   };
   c.prototype.autoPlay = function() {
      this.autoPlayClear();
      this.slideCount > this.options.slidesToShow ? this.autoPlayTimer = setInterval(this.autoPlayIterator, this.options.autoplaySpeed) : util.log(this.$slider.parents(".xg_list")
         .attr("id") + "\u7684\u6570\u91cf\u8981\u8d85\u8fc7\u663e\u793a\u7684\u6570\u91cf\u624d\u4f1a\u64ad\u653e\uff0c\u6216\u5f00\u542f\u5faa\u73af\u64ad\u653e")
   };
   ...
   c.prototype.autoPlayIterator = function() {
      ...
      if (!this.paused && !this.interrupted && !this.focussed) {
         ...
         !1 === this.options.infinite && (1 === this.direction && this.currentSlide + 1 === this.slideCount - 1 ? this.direction = 0 : 0 === this.direction && (a = this.currentSlide - this.options.slidesToScroll, 0 === this.currentSlide - 1 && (this.direction = 1)));
         if (this.options.onBeforeChange && " " != this.options.onBeforeChange)
            if ("string" == typeof this.options.onBeforeChange)(new Function("return typeof " + this.options.onBeforeChange + "!\x3d'undefined' \x26\x26 " + this.options.onBeforeChange + "(" + b + ");"))();
            else this.options.onBeforeChange(this.$slider, b);
         this.slideHandler(a);
         if (this.options.onAfterChange && " " != this.options.onAfterChange)
            if ("string" == typeof this.options.onAfterChange)(new Function("return typeof " + this.options.onAfterChange + "!\x3d'undefined' \x26\x26 " + this.options.onAfterChange + "(" + b + "," + this.currentSlide + ");"))();
            else this.options.onAfterChange(this.$slider, b, this.currentSlide)
      }
   };
   c.prototype.buildArrows = function() {
      !0 === this.options.arrows && (this.$prevArrow = f(this.options.prevArrow)
         .addClass("slick-arrow"), this.$nextArrow = f(this.options.nextArrow)
         .addClass("slick-arrow"), this.slideCount > this.options.slidesToShow ? (this.$prevArrow.removeClass("slick-hidden")
            .removeAttr("aria-hidden tabindex"), this.$nextArrow.removeClass("slick-hidden")
            .removeAttr("aria-hidden tabindex"), this.htmlExpr.test(this.options.prevArrow) && this.$prevArrow.prependTo(this.options.appendArrows), this.htmlExpr.test(this.options.nextArrow) && this.$nextArrow.appendTo(this.options.appendArrows), !0 !== this.options.infinite && this.$prevArrow.addClass("slick-disabled")
            .attr("aria-disabled", "true")) : this.$prevArrow.add(this.$nextArrow)
   ...
   c.prototype.buildDots = function() {
      ...
      if (!0 === this.options.dots) {
         ...
         b = f("\x3cul /\x3e")
            .addClass(this.options.dotsClass);
         for (a = 0; a <= this.getDotCount(); a += 1) b.append(f("\x3cli /\x3e")
            .append(this.options.customPaging.call(this, this, a)));
   ...
   c.prototype.buildOut = function() {
      this.$slides = this.$slider.children(this.options.slide + ":not(.slick-cloned)")
         .addClass("slick-slide");
      this.slideCount = this.$slides.length;
      this.$slides.each(function(a, b) {
         f(b)
            .attr("data-slick-index", a)
            .data("originalStyling", f(b)
               .attr("style") || "")
      });
      this.$slider.addClass("slick-slider");
      this.$slideTrack = 0 === this.slideCount ? f('\x3cdiv class\x3d"slick-track"/\x3e')
         .appendTo(this.$slider) : this.$slides.wrapAll('\x3cdiv class\x3d"slick-track"/\x3e')
         .parent();
      this.$list = this.$slideTrack.wrap('\x3cdiv class\x3d"slick-list"/\x3e')
         .parent();
      this.$slideTrack.css("opacity", 0);
      if (!0 === this.options.centerMode || !0 === this.options.swipeToSlide) this.options.slidesToScroll = 1;
      f("img[data-lazy]", this.$slider)
         .not("[src]")
   ...
   c.prototype.checkResponsive = function(a, b) {
      var e, d, c, h = !1;
      d = this.$slider.width();
      var g = window.innerWidth || f(window)
         .width();
      "window" === this.respondTo ? c = g : "slider" === this.respondTo ? c = d : "min" === this.respondTo && (c = Math.min(g, d));
      if (this.options.responsive && this.options.responsive.length && null !== this.options.responsive) {
         d = null;
         for (e in this.breakpoints) this.breakpoints.hasOwnProperty(e) && (!1 === this.originalSettings.mobileFirst ? c < this.breakpoints[e] && (d = this.breakpoints[e]) : c > this.breakpoints[e] && (d = this.breakpoints[e]));
         if (null !== d)
            if (null !== this.activeBreakpoint) {
               if (d !== this.activeBreakpoint || b) this.activeBreakpoint = d, "unslick" === this.breakpointSettings[d] ? this.unslick(d) : (this.options = f.extend({}, this.originalSettings, this.breakpointSettings[d]), !0 === a && (this.currentSlide = this.options.initialSlide), this.refresh(a)), h = d
            } else this.activeBreakpoint = d, "unslick" === this.breakpointSettings[d] ? this.unslick(d) : (this.options = f.extend({}, this.originalSettings, this.breakpointSettings[d]), !0 === a && (this.currentSlide = this.options.initialSlide), this.refresh(a)), h = d;
         else null !== this.activeBreakpoint && (this.activeBreakpoint = null, this.options = this.originalSettings, !0 === a && (this.currentSlide = this.options.initialSlide), this.refresh(a), h = d);
   ...
   c.prototype.changeSlide = function(a, b) {
      ...
      switch (a.data.message) {
         case "previous":
            if (this.options.onBeforeChange && " " != this.options.onBeforeChange)
               if ("string" == typeof this.options.onBeforeChange)(new Function("return typeof " + this.options.onBeforeChange + "!\x3d'undefined' \x26\x26 " + this.options.onBeforeChange + "(" + c + ");"))();
            ...
            if (this.options.onAfterChange && " " != this.options.onAfterChange)
               if ("string" == typeof this.options.onAfterChange)(new Function("return typeof " + this.options.onAfterChange + "!\x3d'undefined' \x26\x26 " + this.options.onAfterChange + "(" + c + "," + this.currentSlide + ");"))();
         ...
         case "next":
            ...
            break;
         case "index":
            c = 0 === a.data.index ? 0 : a.data.index || e.index() * this.options.slidesToScroll, this.slideHandler(this.checkNavigable(c), !1, b), e.children()
               .trigger("focus")
      }
   };
   ...
   c.prototype.cleanUpEvents = function() {
      this.options.dots && null !== this.$dots && (f("li", this.$dots)
         .off("click.slick", this.changeSlide)
         .off("mouseenter.slick", f.proxy(this.interrupt, this, !0))
         .off("mouseleave.slick", f.proxy(this.interrupt, this, !1)), !0 === this.options.accessibility && this.$dots.off("keydown.slick", this.keyHandler));
      this.$slider.off("focus.slick blur.slick");
      !0 === this.options.arrows && this.slideCount > this.options.slidesToShow && (this.$prevArrow.off("click.slick", this.changeSlide), this.$nextArrow.off("click.slick", this.changeSlide), !0 === this.options.accessibility && (this.$prevArrow.off("keydown.slick", this.keyHandler), this.$nextArrow.off("keydown.slick", this.keyHandler)));
      ...
      f(document)
         .off(this.visibilityChange, this.visibility);
      this.cleanUpSlideEvents();
      !0 === this.options.accessibility && this.$list.off("keydown.slick", this.keyHandler);
      !0 === this.options.focusOnSelect && f(this.$slideTrack)
         .children()
         .off("click.slick", this.selectHandler);
      f(window)
         .off("orientationchange.slick.slick-" + this.instanceUid, this.orientationChange);
      f(window)
         .off("resize.slick.slick-" + this.instanceUid, this.resize);
      f("[draggable!\x3dtrue]", this.$slideTrack)
         .off("dragstart", this.preventDefault);
      f(window)
         .off("load.slick.slick-" + this.instanceUid, this.setPosition)
   };
   ...
   c.prototype.cleanUpRows = function() {
      var a;
      1 < this.options.rows && (a = this.$slides.children()
         .children(), a.removeAttr("style"), this.$slider.empty()
         .append(a))
   };
   ...
   c.prototype.destroy = function(a) {
      ...
      this.touchObject = {};
      this.cleanUpEvents();
      f(".slick-cloned", this.$slider)
         .detach();
      this.$dots && this.$dots.remove();
      this.$prevArrow && this.$prevArrow.length && (this.$prevArrow.removeClass("slick-disabled slick-arrow slick-hidden")
         .removeAttr("aria-hidden aria-disabled tabindex")
         .css("display", ""), this.htmlExpr.test(this.options.prevArrow) && this.$prevArrow.remove());
      this.$nextArrow && this.$nextArrow.length && (this.$nextArrow.removeClass("slick-disabled slick-arrow slick-hidden")
         .removeAttr("aria-hidden aria-disabled tabindex")
         .css("display", ""), this.htmlExpr.test(this.options.nextArrow) && this.$nextArrow.remove());
      this.$slides && (this.$slides.removeClass("slick-slide slick-active slick-center slick-visible slick-current")
         ...
         .detach(), this.$slideTrack.detach(), this.$list.detach(), this.$slider.append(this.$slides));
      this.cleanUpRows();
   ...
   c.prototype.fadeSlide = function(a, b) {
      var e = this;
      !1 === e.cssTransitions ? (e.$slides.eq(a)
         .css({
            zIndex: e.options.zIndex
         }), e.$slides.eq(a)
         .animate({
            opacity: 1
         }, e.options.speed, e.options.easing, b)) : (e.applyTransition(a), e.$slides.eq(a)
         .css({
            opacity: 1,
            zIndex: e.options.zIndex
   ...
   c.prototype.fadeSlideOut = function(a) {
      !1 === this.cssTransitions ? this.$slides.eq(a)
         .animate({
            opacity: 0,
            zIndex: this.options.zIndex - 2
         }, this.options.speed, this.options.easing) : (this.applyTransition(a), this.$slides.eq(a)
            .css({
               opacity: 0,
               zIndex: this.options.zIndex - 2
            }))
   ...
   c.prototype.filterSlides = c.prototype.slickFilter = function(a) {
      null !== a && (this.$slidesCache = this.$slides, this.unload(), this.$slideTrack.children(this.options.slide)
         .detach(), this.$slidesCache.filter(a)
   ...
   c.prototype.getLeft = function(a) {
      ...
      b = !1 === this.options.vertical ? a * this.slideWidth * -1 + this.slideOffset : a * b * -1 + e;
      !0 === this.options.variableWidth && (e = this.slideCount <= this.options.slidesToShow || !1 === this.options.infinite ? this.$slideTrack.children(".slick-slide")
         .eq(a) : this.$slideTrack.children(".slick-slide")
         .eq(a + this.options.slidesToShow), b = !0 === this.options.rtl ? e[0] ? -1 * (this.$slideTrack.width() - e[0].offsetLeft - e.width()) : 0 : e[0] ? -1 * e[0].offsetLeft : 0, !0 === this.options.centerMode && (e = this.slideCount <= this.options.slidesToShow || !1 === this.options.infinite ? this.$slideTrack.children(".slick-slide")
            .eq(a) : this.$slideTrack.children(".slick-slide")
            .eq(a + this.options.slidesToShow + 1), b = !0 === this.options.rtl ? e[0] ? -1 * (this.$slideTrack.width() - e[0].offsetLeft - e.width()) : 0 : e[0] ? -1 * e[0].offsetLeft : 0, b += (this.$list.width() - e.outerWidth()) / 2));
      return b
   };
   ...
   c.prototype.getNavigableIndexes = function() {
      ...
      for (; a < d;) e.push(a), a = b + this.options.slidesToScroll, b += this.options.slidesToScroll <= this.options.slidesToShow ? this.options.slidesToScroll : this.options.slidesToShow;
      return e
   };
   ...
   c.prototype.getSlideCount = function() {
      ...
      return !0 === a.options.swipeToSlide ? (a.$slideTrack.find(".slick-slide")
         .each(function(b, c) {
            if (c.offsetLeft - d + f(c)
               .outerWidth() / 2 > -1 * a.swipeLeft) return e = c, !1
         }), b = Math.abs(f(e)
   ...
   c.prototype.init = function(a) {
      f(this.$slider)
         .hasClass("slick-initialized") || (f(this.$slider)
            .addClass("slick-initialized"), this.buildRows(), this.buildOut(), this.setProps(), this.startLoad(), this.loadSlider(), this.initializeEvents(), this.updateArrows(), this.updateDots(), this.checkResponsive(!0), this.focusHandler());
      a && this.$slider.trigger("init", [this]);
      this.$slides && !0 === this.options.accessibility && this.initADA();
      this.$slides && this.options.autoplay && (this.paused = !1, this.autoPlay())
   };
   c.prototype.initADA = function() {
      var a = this,
         b = Math.ceil(a.slideCount / a.options.slidesToShow),
         e = a.getNavigableIndexes()
         .filter(function(b) {
            return 0 <= b && b < a.slideCount
         });
      a.$slides.add(a.$slideTrack.find(".slick-cloned"))
         .attr({
            "aria-hidden": "true",
            tabindex: "-1"
         })
      ...
      null !== a.$dots && (a.$slides.not(a.$slideTrack.find(".slick-cloned"))
         .each(function(b) {
            var d = e.indexOf(b);
            f(this)
               .attr({
         ...
         .end());
      for (var d = a.currentSlide, c = d + a.options.slidesToShow; d < c; d++) a.$slides.eq(d)
         .attr("tabindex", 0);
      a.activateADA()
   };
   c.prototype.initArrowEvents = function() {
      if (!util.inDesign() && (!0 === this.options.arrows && (this.$prevArrow.off("click.slick")
         .on("click.slick", {
            message: "previous"
         }, this.changeSlide), this.$nextArrow.off("click.slick")
         .on("click.slick", {
            message: "next"
         }, this.changeSlide), !0 === this.options.accessibility && (this.$prevArrow.on("keydown.slick", this.keyHandler), this.$nextArrow.on("keydown.slick", this.keyHandler))), !0 === this.options.dots)) {
         f("li", this.$dots)
            .on("click.slick", {
               message: "index"
            }, this.changeSlide);
         if (!0 === this.options.accessibility) this.$dots.on("keydown.slick", this.keyHandler);
         if (!0 === this.options.pauseOnDotsHover) f("li", this.$dots)
   ...
   c.prototype.initDotEvents = function() {
      if (!util.inDesign()) {
         if (!0 === this.options.dots && (f("li", this.$dots)
            .on("click.slick", {
               message: "index"
            }, this.changeSlide), !0 === this.options.accessibility)) this.$dots.on("keydown.slick", this.keyHandler);
         if (!0 === this.options.dots && !0 === this.options.pauseOnDotsHover) f("li", this.$dots)
            .on("mouseenter.slick", f.proxy(this.interrupt, this, !0))
            .on("mouseleave.slick", f.proxy(this.interrupt, this, !1))
      }
   };
   ...
   c.prototype.initializeEvents = function() {
      ...
      if (this.options.pcMouseTouch && 1 == a || 2 == a) this.$list.on("touchstart.slick mousedown.slick", {
         action: "start"
      ...
      f(document)
         .on(this.visibilityChange, f.proxy(this.visibility, this));
      if (!0 === this.options.accessibility) this.$list.on("keydown.slick", this.keyHandler);
      if (!0 === this.options.focusOnSelect) f(this.$slideTrack)
         .children()
         .on("click.slick", this.selectHandler);
      f(window)
         .on("orientationchange.slick.slick-" + this.instanceUid, f.proxy(this.orientationChange, this));
      f(window)
         .on("resize.slick.slick-" + this.instanceUid, f.proxy(this.resize, this));
      f("[draggable!\x3dtrue]", this.$slideTrack)
   ...
   c.prototype.initUI = function() {
      !0 === this.options.arrows && this.slideCount > this.options.slidesToShow && (this.$prevArrow.css("display", ""), this.$nextArrow.css("display", ""));
   ...
   c.prototype.lazyLoad = function() {
         ...
         f("img[data-lazy]", a)
            .each(function() {
               var a = f(this),
                  ...
                  .attr("data-srcset"),
                  c = f(this)
                  .attr("data-sizes") || b.$slider.attr("data-sizes"),
                  ...
                  a.animate({
                     ...
                     a.attr("src", d)
                        .animate({
                           ...
                           a.removeAttr("data-lazy data-srcset data-sizes")
      ...
      var b = this,
         e, d, c;
      !0 === b.options.centerMode ? !0 === b.options.infinite ? (d = b.currentSlide + (b.options.slidesToShow / 2 + 1), c = d + b.options.slidesToShow + 2) : (d = Math.max(0, b.currentSlide - (b.options.slidesToShow / 2 + 1)), c = 2 + (b.options.slidesToShow / 2 + 1) + b.currentSlide) : (d = b.options.infinite ? b.options.slidesToShow + b.currentSlide : b.currentSlide, c = Math.ceil(d + b.options.slidesToShow), !0 === b.options.fade && (0 < d && d--, c <= b.slideCount && c++));
      e = b.$slider.find(".slick-slide")
         .slice(d, c);
      if ("anticipated" === b.options.lazyLoad) {
         --d;
         for (var h = b.$slider.find(".slick-slide"), g = 0; g < b.options.slidesToScroll; g++) 0 > d && (d = b.slideCount - 1), e = e.add(h.eq(d)), e = e.add(h.eq(c)), d--, c++
      }
      a(e);
      b.slideCount <= b.options.slidesToShow ? (e = b.$slider.find(".slick-slide"), a(e)) : b.currentSlide >= b.slideCount - b.options.slidesToShow ? (e = b.$slider.find(".slick-cloned")
         .slice(0, b.options.slidesToShow), a(e)) : 0 === b.currentSlide && (e = b.$slider.find(".slick-cloned")
         .slice(-1 * b.options.slidesToShow), a(e))
   };
   ...
   c.prototype.postSlide = function(a) {
      this.unslicked || (this.$slider.trigger("afterChange", [this, a]), this.animating = !1, this.slideCount > this.options.slidesToShow && this.setPosition(), this.swipeLeft = null, this.options.autoplay && this.autoPlay(), !0 === this.options.accessibility && (this.initADA(), this.options.focusOnChange && f(this.$slides.get(this.currentSlide))
         .attr("tabindex", 0)
         .focus()))
   };
   ...
   c.prototype.progressiveLazyLoad = function(a) {
      ...
      var b = this,
         ...
         d, c, h, g;
      e.length ? (d = e.first(), c = d.attr("data-lazy"), h = d.attr("data-srcset"), g = d.attr("data-sizes") || b.$slider.attr("data-sizes"), e = document.createElement("img"), e.onload = function() {
         ...
         }, 500) : (d.removeAttr("data-lazy")
            .removeClass("slick-loading")
            .addClass("slick-lazyload-error"), b.$slider.trigger("lazyLoadError", [b, d, c]), b.progressiveLazyLoad())
      }, e.src = c) : b.$slider.trigger("allImagesLoaded", [b])
   };
   ...
   c.prototype.registerBreakpoints = function() {
      var a = this,
         b, e, d, c = a.options.responsive || null;
      if ("array" === f.type(c) && c.length) {
         a.respondTo = a.options.respondTo || "window";
         for (b in c)
            if (d = a.breakpoints.length - 1, c.hasOwnProperty(b)) {
               for (e = c[b].breakpoint; 0 <= d;) a.breakpoints[d] && a.breakpoints[d] === e && a.breakpoints.splice(d, 1), d--;
   ...
   c.prototype.resize = function() {
      var a = this;
      f(window)
         .width() !== a.windowWidth && (clearTimeout(a.windowDelay), a.windowDelay = window.setTimeout(function() {
            a.windowWidth = f(window)
               .width();
            a.checkResponsive();
   ...
   c.prototype.removeSlide = c.prototype.slickRemove = function(a, b, e) {
      ...
      this.unload();
      !0 === e ? this.$slideTrack.children()
         .remove() : this.$slideTrack.children(this.options.slide)
         .eq(a)
         .remove();
      this.$slides = this.$slideTrack.children(this.options.slide);
      this.$slideTrack.children(this.options.slide)
   ...
   c.prototype.setDimensions = function() {
      ...
      }) : (this.$list.height(this.$slides.first()
         .outerHeight(!0) * this.options.slidesToShow), !0 === this.options.centerMode && this.$list.css({
         padding: this.options.centerPadding + " 0px"
      }));
      this.listWidth = this.$list.width();
      this.listHeight = this.$list.height();
      !1 === this.options.vertical && !1 === this.options.variableWidth ? (this.slideWidth = Math.ceil(this.listWidth / this.options.slidesToShow), this.$slideTrack.width(Math.ceil(this.slideWidth * this.$slideTrack.children(".slick-slide")
         .length))) : !0 === this.options.variableWidth ? this.$slideTrack.width(5E3 * this.slideCount) : (this.slideWidth = Math.ceil(this.listWidth), this.$slideTrack.height(Math.ceil(this.$slides.first()
         .outerHeight(!0) * this.$slideTrack.children(".slick-slide")
         .length)));
      var a = this.$slides.first()
         .outerWidth(!0) - this.$slides.first()
         .width();
      !1 === this.options.variableWidth && this.$slideTrack.children(".slick-slide")
         .width(this.slideWidth - a);
      if (!1 === this.options.vertical && this.$prevArrow && this.$nextArrow && this.$slider.offset()
         .top > document.documentElement.clientHeight) {
         ...
         } else this.$prevArrow.css("margin-left", "0px"), this.$nextArrow.css("margin-right", "0px")
      }
   };
   ...
   c.prototype.setOption = c.prototype.slickSetOption = function(a, b, e) {
      var d = this,
         c, h, g, l = !1,
         k;
      "object" === f.type(a) ? (h = a, l = b, k = "multiple") : "string" === f.type(a) && (h = a, g = b, l = e, "responsive" === a && "array" === f.type(b) ? k = "responsive" : "undefined" !== typeof b && (k = "single"));
      if ("single" === k) d.options[h] = g;
      else if ("multiple" === k) f.each(h, function(a, b) {
         d.options[a] = b
      });
      else if ("responsive" === k)
         for (c in g)
            if ("array" !== f.type(d.options.responsive)) d.options.responsive = [g[c]];
            else {
               for (a = d.options.responsive.length - 1; 0 <= a;) d.options.responsive[a].breakpoint === g[c].breakpoint && d.options.responsive.splice(a, 1), a--;
   ...
   c.prototype.setSlideClasses = function(a) {
      ...
      if (!0 === this.options.centerMode) {
         ...
         !0 === this.options.infinite && (a >= b && a <= this.slideCount - 1 - b ? this.$slides.slice(a - b + c, a + b + 1)
            .addClass("slick-active")
            .attr("aria-hidden", "false") : (d = this.options.slidesToShow + a, e.slice(d - b + 1 + c, d + b + 2)
               .addClass("slick-active")
               .attr("aria-hidden", "false")), 0 === a ? e.eq(e.length - 1 - this.options.slidesToShow)
            .addClass("slick-center") : a === this.slideCount - 1 && e.eq(this.options.slidesToShow)
            .addClass("slick-center"));
         this.$slides.eq(a)
            .addClass("slick-center")
      } else 0 <= a && a <= this.slideCount - this.options.slidesToShow ? this.$slides.slice(a, a + this.options.slidesToShow)
         .addClass("slick-active")
         .attr("aria-hidden", "false") : e.length <= this.options.slidesToShow ? e.addClass("slick-active")
         .attr("aria-hidden", "false") : (b = this.slideCount % this.options.slidesToShow, d = !0 === this.options.infinite ? this.options.slidesToShow + a : a, this.options.slidesToShow == this.options.slidesToScroll && this.slideCount - a < this.options.slidesToShow ? e.slice(d - (this.options.slidesToShow - b), d + b)
            .addClass("slick-active")
            .attr("aria-hidden", "false") : e.slice(d, d + this.options.slidesToShow)
            .addClass("slick-active")
   ...
   c.prototype.setupInfinite = function() {
      ...
      if (!0 === this.options.infinite && !1 === this.options.fade && (b = null, this.slideCount > this.options.slidesToShow)) {
         ...
         for (a = this.slideCount; a > this.slideCount - e; --a) b = a - 1, f(this.$slides[b])
            .clone(!0)
            .attr("id", "")
            .attr("data-slick-index", b - this.slideCount)
            .prependTo(this.$slideTrack)
            .addClass("slick-cloned");
         for (a = 0; a < e + this.slideCount; a += 1) b = a, f(this.$slides[b])
            .clone(!0)
            .attr("id", "")
            .attr("data-slick-index", b + this.slideCount)
            .appendTo(this.$slideTrack)
            .addClass("slick-cloned");
         this.$slideTrack.find(".slick-cloned")
            .find("[id]")
            .each(function() {
               f(this)
                  .attr("id", "")
   ...
   c.prototype.selectHandler = function(a) {
      a = f(a.target)
         .is(".slick-slide") ? f(a.target) : f(a.target)
         .parents(".slick-slide");
   ...
   c.prototype.slideHandler = function(a, b, e) {
      ...
      if (!0 !== g.animating || !0 !== g.options.waitForAnimate)
         if (!0 !== g.options.fade || g.currentSlide !== a) !1 === (b || !1) && g.asNavFor(a), d = a, f = g.getLeft(d), b = g.getLeft(g.currentSlide), g.currentLeft = null === g.swipeLeft ? b : g.swipeLeft, !1 === g.options.infinite && !1 === g.options.centerMode && (0 > a || a > g.getDotCount() * g.options.slidesToScroll) ? !1 === g.options.fade && (d = g.currentSlide, !0 !== e ? g.animateSlide(b, function() {
            g.postSlide(d)
         }) : g.postSlide(d)) : !1 === g.options.infinite && !0 === g.options.centerMode && (0 > a || a > g.slideCount - g.options.slidesToScroll) ? !1 === g.options.fade && (d = g.currentSlide, !0 !== e ? g.animateSlide(b, function() {
            g.postSlide(d)
         }) : g.postSlide(d)) : (g.options.autoplay && clearInterval(g.autoPlayTimer), c = 0 > d ? 0 !== g.slideCount % g.options.slidesToScroll ? g.slideCount - g.slideCount % g.options.slidesToScroll : g.slideCount + d : d >= g.slideCount ? 0 !== g.slideCount % g.options.slidesToScroll ? 0 : d - g.slideCount : d, g.animating = !0, g.$slider.trigger("beforeChange", [g, g.currentSlide, c]), a = g.currentSlide, g.currentSlide = c, g.setSlideClasses(g.currentSlide), g.options.asNavFor && (b = g.getNavTarget(), b = b.slick("getSlick"), b.slideCount <= b.options.slidesToShow && b.setSlideClasses(g.currentSlide)), g.updateDots(), g.updateArrows(), !0 === g.options.fade ? (!0 !== e ? (g.fadeSlideOut(a), g.fadeSlide(c, function() {
            g.postSlide(c)
         })) : g.postSlide(c), g.animateHeight()) : !0 !== e ? g.animateSlide(f, function() {
            g.postSlide(c)
         }) : g.postSlide(c))
   };
      ...
      if (!(!1 === this.options.swipe || "ontouchend" in document && !1 === this.options.swipe || !1 === this.options.draggable && -1 !== a.type.indexOf("mouse"))) {
         ...
         switch (a.data.action) {
            ...
            case "move":
               ...
               break;
            case "end":
               if (this.swipeEnd(a), this.options.onAfterChange && " " != this.options.onAfterChange)
                  if ("string" == typeof this.options.onAfterChange)(new Function("return typeof " + this.options.onAfterChange + "!\x3d'undefined' \x26\x26 " + this.options.onAfterChange + "(" + b + "," + this.currentSlide + ");"))();
                  else this.options.onAfterChange(this.$slider, b, this.currentSlide)
         }
      }
   ...
   c.prototype.swipeMove = function(a) {
      ...
      if (!this.options.verticalSwiping && !this.swiping && 4 < c) return this.scrolling = !0, !1;
   ...
   c.prototype.unfilterSlides = c.prototype.slickUnfilter = function() {
      null !== this.$slidesCache && (this.unload(), this.$slideTrack.children(this.options.slide)
         .detach(), this.$slidesCache.appendTo(this.$slideTrack), this.reinit())
   };
   c.prototype.unload = function() {
      ...
      this.$slides.removeClass("slick-slide slick-active slick-visible slick-current")
         .attr("aria-hidden", "true")
         .css("width", "")
   };
   ...
   c.prototype.updateArrows = function() {
      !0 === this.options.arrows && this.slideCount > this.options.slidesToShow && !this.options.infinite && (this.$prevArrow.removeClass("slick-disabled")
         .attr("aria-disabled", "false"), this.$nextArrow.removeClass("slick-disabled")
         .attr("aria-disabled", "false"), 0 === this.currentSlide ? (this.$prevArrow.addClass("slick-disabled")
            .attr("aria-disabled", "true"), this.$nextArrow.removeClass("slick-disabled")
            .attr("aria-disabled", "false")) : this.currentSlide >= this.slideCount - this.options.slidesToShow && !1 === this.options.centerMode ? (this.$nextArrow.addClass("slick-disabled")
            .attr("aria-disabled", "true"), this.$prevArrow.removeClass("slick-disabled")
            .attr("aria-disabled", "false")) : this.currentSlide >= this.slideCount - 1 && !0 === this.options.centerMode && (this.$nextArrow.addClass("slick-disabled")
            .attr("aria-disabled", "true"), this.$prevArrow.removeClass("slick-disabled")
            .attr("aria-disabled", "false")))
   };
   c.prototype.updateDots = function() {
      null !== this.$dots && (this.$dots.find("li")
         .removeClass("slick-active")
         .end(), this.$dots.find("li")
   ...
   c.prototype.iosCompatibility = function() {
      -1 != navigator.userAgent.indexOf("iPhone") && "undefined" != typeof page && (screen.width <= page.splitMobileWidth ? this.$slider.css("width", this.$slider.parent()
         .width() + "px") : this.$slider.css({
         width: ""
      }))
   };
   f.fn.slick = function() {
      ...
      var a = arguments[0],
         ...
         d, f;
      for (d = 0; d < e; d++)
         if ("object" == typeof a || "undefined" == typeof a ? this[d].slick = new c(this[d], a) : f = this[d].slick && this[d].slick[a].apply(this[d].slick, b), "undefined" != typeof f) return f;
      "undefined" != typeof page && 2 == page.currentDevice() && this.parent()
         .width() == document.documentElement.clientWidth && (this.css("width", document.documentElement.clientWidth + "px"), "undefined" != typeof banner && (banner.iosCompatibility = function(a) {
